...
class KuehneNagelConfigSettings(models.TransientModel):
    ...
    kuehne_office_country_id = fields.Many2one(
        related="warehouse_id.kuehne_office_country_id", comodel_name="res.country"
    )
    ...
    kuehne_tracking_url = fields.Char(related="warehouse_id.kuehne_tracking_url")
    kuehne_sender_id = fields.Char(related="warehouse_id.kuehne_sender_id")
